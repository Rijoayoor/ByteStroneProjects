...
using service.Core.ProjectAggregate;
using service.Core.ProjectAggregate.Events;
using service.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace service.UnitTests.Core.Handlers;
