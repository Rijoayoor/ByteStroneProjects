...
do
{
  ...
  switch (menuSelection)
  {
    ...
    case "5":
      ...
      Console.WriteLine("Enter animal id to edit age");
      readResult=Console.ReadLine();
      readResult="ID #: " + readResult;
      for(int animalIndex=0;animalIndex<5;animalIndex++)
      {
        if(ourAnimals[animalIndex,0]==readResult)
        {
          Console.WriteLine("enter new age:");
          newAge=Console.ReadLine();
          ourAnimals[animalIndex,2]="Age: "+newAge;
          break;
        }
      }
      Console.WriteLine("Press the Enter key to continue.");
    ...
    case "6":
      ...
      Console.WriteLine("Enter animal id to edit personality description");
      readResult=Console.ReadLine();
      readResult="ID #: " + readResult;
      for(int animalIndex=0;animalIndex<5;animalIndex++)
      {
        if(ourAnimals[animalIndex,0]==readResult)
        {
          Console.WriteLine("Enter new personality:");
          newPersonality=Console.ReadLine();
          ourAnimals[animalIndex,5]="Personality: "+newPersonality;
          break;
        }
      }
      Console.WriteLine("Press the Enter key to continue.");
    ...
    case "7":
      ...
      Console.WriteLine("Enter the characteristics");
      readResult=Console.ReadLine();

      for(int animalIndex=0;animalIndex<5;animalIndex++)
      {
        if(ourAnimals[animalIndex,1]=="Species: cat" && ourAnimals[animalIndex,4].Contains(readResult))
        {
          Console.WriteLine(ourAnimals[animalIndex,0]);
          Console.WriteLine(ourAnimals[animalIndex,1]);
          Console.WriteLine(ourAnimals[animalIndex,2]);
          Console.WriteLine(ourAnimals[animalIndex,3]);
          Console.WriteLine(ourAnimals[animalIndex,4]);
          Console.WriteLine(ourAnimals[animalIndex,5]);  
    ...
    case "8":
      ...
      for(int animalIndex=0;animalIndex<5;animalIndex++)
      {
        if(ourAnimals[animalIndex,1]=="Species: dog" && ourAnimals[animalIndex,4].Contains(readResult))
        {
          Console.WriteLine(ourAnimals[animalIndex,0]);
          Console.WriteLine(ourAnimals[animalIndex,1]);
          Console.WriteLine(ourAnimals[animalIndex,2]);
